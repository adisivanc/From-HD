...
function getSeoUrl($argvs=array()){
	...
	switch($pn)
	{
		...
		if($act!='')
		{
		$seourl = "NMed-faculty/".NMed-faculty."?act=display";	
		}
		else
		 {
		  $seourl = 'NMed-faculty';
		...
		case 'team.php':{
		$seourl='organizing-committee';
		break;
		}
		case 'faculty_detail.php':
		{
			if($Id>0){
				$user_obj= new Speaker();
				$user_obj->id=$Id;
				$rs_speaker=$user_obj->getSpeakerDtl();
			
				$seourl=getSeoName(trim($rs_speaker->SEO_Name));
			}	
		  break; 
		}
		
		case 'snmidetails.php':{
		$seourl='snmi-details';
		break;
		}
		case 'warmth.php':{
		$seourl='warmth-details';
		break;
		}
		case 'snmiofficer.php':{
		$seourl='snmi-office-bearers';
		break;
		}
		case 'coimbatore.php':{
		$seourl='about-coimbatore';
		break;
		}
		case 'layout_highlights.php':{
		$seourl='conference-highlights';
		break;
		}
		case 'sponsors.php':{
		$seourl='sponsors';
		...
		case 'industry_participation.php':{
		$seourl='industry-participation';
		break;
		}
		case 'accomodation.php':{
		$seourl='accomodation';
		break;
		}
		case 'privacy.php':{
		...
		case 'issue1.php':{
		$seourl='newsletter/newsletter-issue1';
		break;
		}

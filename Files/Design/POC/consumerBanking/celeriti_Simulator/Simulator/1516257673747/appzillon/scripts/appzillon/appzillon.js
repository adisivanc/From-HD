...
Apz.prototype = {
      ...
      */
      ...
      if (params.obj.tagName=="INPUT") {
         ...
         for (var i = 0; i < params.options.length; i++) {
            optLi = $("<li id='"+params.obj.id+"_option_"+params.options[i].desc+"' class='form-group--checkbox' value='"+params.options[i].val+"'></li>");
            ...
            if(!this.isNull(params.options[i].childs)&& params.options[i].childs.length > 0){
            	...
            	for(var i=0,len=childArr.length;i<len;i++){
            		var $optLi1 = $("<li id='"+params.obj.id+"_option_child"+childArr[i].desc+"' class='form-group--checkbox' value='"+childArr[i].val+"'></li>");
   ...
   loadUserPrefs : function(res) {
      ...
      this.sslPinning = props.sslPinning ? props.sslPinning : "N";
...
/*            if (!this.isNull(gaugeObj.nodes)) {
   ...
   loadProject : function() {
      ...
      if (this.deviceOs != "MCA" && this.deviceOs != "WEB" && this.deviceOs != "SIMULATOR") {

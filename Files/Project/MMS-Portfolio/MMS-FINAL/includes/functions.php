...
function getSeoUrl($argvs=array()){
   ...
   $siteprefix = BASE_URL;
	...
	switch($pn)
	{
		...
		case 'contact.php':
		{
		$seourl='contact-mastermind-solutions';
		break;
		}
		...
		case 'about.php':
		{
		$seourl='about-mastermind-solutions';
		break;
		}
		case 'career.php':
		{
		$seourl='careers-mastermind-solutions';
		break;
		}
		case 'career_form.php':
		{
			if($Type)
			{
				switch($Type)
				{
					case 'PHPDEV':
					{
						$seourl='careers-php-developer';	
						break;
					}
					case 'JPHPDEV':
					{
						$seourl='careers-junior-php-developer';	
						break;
					}
				}
			}

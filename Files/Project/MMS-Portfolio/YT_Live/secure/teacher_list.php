...
<div class="fullsize_pad padtb10 lineht1_8 border_bottom">
    ...
    <span class="bgbrown txtwhite padtb5 padlr20 cursor" onClick="showTeacherListDtls('<?=$status?>', 'D')" style="margin-right:120px;"><strong>Search</strong></span>
    <div class="pull_right">
    	<? if($_SESSION['viewLog']) { ?><div class="combutton" onclick="showLogDetails('<?=TBL_TEACHER?>', '<?=$teacherId?>')">Logs</div><? } ?>
    </div>
</div>

...
function upgradeStudentGrade(student_ids, grade_id, action) {
	...
	var grade_circular_id = $('#grade_circular_id').val();
	
	if(err==0) {
		ajax({
			a:'grade',
			b:'act=updateStudentGrade&gradeId='+grade_id+'&studentIds='+studentIds+'&schoolId='+school_id+'&gradeSection='+grade_section+'&newGradeId='+new_grade_id+'&gradeCircularId='+grade_circular_id,		
			c:function(){},
...
function showEmailSubscription(id) {
	ajax({
		a:'students',
		b:'act=loadEmailSubscriptions&studentId='+id,
		c:function(){},
		d:function(data){ 
			popupDtls(data);
		}			
...
function updateEmailSubscription(id) {
	var fatherEmail = $('input[name=f_email_subs]:checked').val();
	var motherEmail = $('input[name=m_email_subs]:checked').val();
	var emerEmail = $('input[name=e_email_subs]:checked').val();
	
	$('#subsSaveImg').hide();
	$('#subsLoadingImg').show();
	ajax({
		a:'students',
		b:'act=updateEmailSubs&studentId='+id+'&fatherEmail='+fatherEmail+'&motherEmail='+motherEmail+'&emerEmail='+emerEmail,
		c:function(){},
		d:function(data){ 
			alert(data);
			closePopup();

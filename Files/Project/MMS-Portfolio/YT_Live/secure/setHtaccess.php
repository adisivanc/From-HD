...
function SetUpHtAccess(){
	...
	$SitePages = array('index.php','yt_grade_school.php','curriculum.php','contact.php','free_human_being.php','yt_fundamentals.php','teacher.php','yt_rhythm.php','yt_methodology.php','yt_practices.php','belief.php','press.php','videos.php','faq.php','joinus.php','newsletter/indian_rollers.php','newsletter/drongos.php','philosophy.php','garden_campus.php','garden_teachers.php','garden_program.php','garden_rhythm.php','admission.php');

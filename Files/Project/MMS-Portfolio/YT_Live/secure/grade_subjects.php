...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:7px auto;" class="gradetbl"> <!--Subjects Tab-->
  ...
  <tr>
    ...
    <td>
    	<? if($GLOBALS['isDelete']){ ?><img src="images/delete_icon.png" alt="Delete" title="Delete" class="cursor" onclick="if(confirm('Are you sure want to remove this subject from the grade?, If yes this the assigned teacher also will remove from this subject')) showSubFrm('D', <?=$gradeId?>, <?=$V->id?>)" /><? } ?>
    </td>
  </tr>
  <?
	  }

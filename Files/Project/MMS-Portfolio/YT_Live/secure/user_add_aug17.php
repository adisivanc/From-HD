        ...
        <td colspan="2" style="">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px; float:left; background:#dab791;">
              <tr>
                ...
                <td valign="top">
					<input type="checkbox" class="check_lg" id="acc_control_b" name="acc_control" value="B" />
                </td>
              </tr>
            </table>
        ...
        <td colspan="2" style="">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px; float:left; background:#dab791;">
              <tr>
                ...
                <td valign="top">
					<input type="checkbox" class="acc_control" id="acc_control_e" name="acc_control" value="E"/>
                </td>
              </tr>
            </table>
        ...
        <td colspan="2" style="">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px; float:left; background:#dab791;">
              <tr>
                ...
                <td valign="top">
					<input type="checkbox" class="check_lg" id="acc_control_n" name="acc_control" value="N"/>
                </td>
              </tr>
            </table>

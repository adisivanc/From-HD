...
<div class="fullsize border_theme pad10">
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="tbl" id="showBasicDtls">
        ...
        <tr>
        	<td id="sendcircularerr">Send Email</td>
            <td>
            	<input type="radio" name="send_circular" id="send_circular1" value="Y" onclick="showCircularDtl('S')" /> Yes
                <input type="radio" name="send_circular" id="send_circular1" value="N" onclick="showCircularDtl('S')" /> No
            </td>
        </tr>
        ...
        <tr class="selcirculartab" style="display:none;">
            ...
            <td>
            <?
				$rs_ciruclars = Circulars::getMailTemplates($GLOBALS['MailTemplateCategoryTypes']['Student']);
			?>

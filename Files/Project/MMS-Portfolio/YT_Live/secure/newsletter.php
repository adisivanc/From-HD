...
if($_POST['act']=="saveCircular") {
	...
	for($i=1; $i<=$no_of_inner_image; $i++) {
		...
		if($_FILES['inner_image'.$i]['size'] > 0)
		{
			...
			$rExt = array('jpg','jpeg','png','gif','pdf','xls','doc','docx','xlsx','ppt','pptx');
			$FileObj = new FileUpload();
                ...
                <table>
                    ...
                    <tr>
                      <td  width="40%" height="30" colspan="2" align="center">
                        ...
                        <div class="combutton pull_right padlr10 padtb10 txtbold letterspac f18" id="testmailloadingbtn" style="display:none;">Sending..</div>
                      </td>
                   </tr>
                </table>
             </td>

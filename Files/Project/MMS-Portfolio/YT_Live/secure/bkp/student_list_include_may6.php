...
if(count($rs_studentArr)>0){
    ...
    ?>
        <tr bgcolor="#FFFFFF" style="<?=$txtcolor?>">
            ...
            <img src="images/edit_icon1.png" alt="Quick Edit Student" title="Quick Edit Student" class="actionicons" onClick="showStudentFrm('<?=$V->id?>', 'QF');" /><br />
            ...
            <img src="images/mailsub_icon.png" alt="Email Subscriptions" title="Email Subscriptions" align="absmiddle" class="actionicons" onclick="showEmailSubscription('<?=$V->id?>')" />

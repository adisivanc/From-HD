					...
					<tbody>
						...
						<tr>
                            ...
                            <? if($header_type=="I" && $headerArr['Img']!="") { ?>
								<img alt="<?=$title?>" title="<?=$title?>" border="0" src="<?=$ns_header_path.$headerArr['Img']?>" />
							<? } ?>
                            <? if($header_type=="T") { ?>
							...
							<td>
								<table width="745" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto; padding:12px 0;">
                                  ...
                                  <tr>
                                    ...
                                    <td style="padding:10px 0px;"><img src="<?=$ns_welcom_path.$iv?>" alt="Sports Day" style="margin-right:2px;" /></td>
                                    <? } ?>

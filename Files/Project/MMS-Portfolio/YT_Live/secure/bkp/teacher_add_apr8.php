...
<div class="newsletter_cntr">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
          ...
          <tr>
			...
			<? $subjectArr=explode(",", $rs_teacher->subject_id);
				$sub_obj = new Subject();
				if($_SESSION['SchoolId']!='A'){ $sub_obj->school_id = $_SESSION['SchoolId']; }
				$sub_obj->orderby = 'id';
				$sub_obj->sortby = 'ASC';
    ...
    <div class="fullsize txtwhite txtcenter f18">
        ...
        <div class="bgbrown pull_right marginleft20 margintb10 cursor padlr20 padtb10" onClick="submitTeacher('S')"><strong>SAVE</strong></div>
        <div class="bgbrown pull_right marginleft20 margintb10 cursor padlr20 padtb10" onClick="submitTeacher('A')"><strong>ADD</strong></div>
        <? if($rs_teacher->id!="") { ?><div class="bgbrown pull_right margintb10 cursor padlr20 padtb10" onClick="submitTeacher('I')"><strong>Arichive</strong></div><? } ?>
    </div> 
...
function submitTeacher(action){ 
	...
	if($('input[name=teacher_gender]:checked').val()==undefined){ total_err=1; $('#gendererr').addClass('txterror'); } else { $('#gendererr').removeClass('txterror'); }
	...
	if($('input[name=is_verified]:checked').val()==undefined){ total_err=1; $('#verifiederr').addClass('txterror'); } else { $('#verifiederr').removeClass('txterror'); }
	...
	if($('input[class=teacher_handling]:checked').val()==undefined){ total_err=1; $('#handlingerr').addClass('txterror'); } else { $('#handlingerr').removeClass('txterror'); }

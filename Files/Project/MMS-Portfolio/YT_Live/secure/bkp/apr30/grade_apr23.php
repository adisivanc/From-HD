    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="popuptbl">
        ...
        <tr>
            <td colspan="2">
                ...
                <tr><td colspan="2" align="left">Please make sure these students are new students. New students are listed below:</td></tr>
        ...
        <tr>
        	<td colspan="2" align="right">
            	<div class="fullsize txtwhite txtcenter f18">
                    <div class="bgbrown pull_right marginleft20 margintb10 cursor padlr20 padtb10" onClick="updateNewStudent('<?=$gradeId?>')" id="saveBtn"><strong>Make New Student</strong></div>
...
if($_POST['act']=="setNewStudents") {
	...
	$gradeSection = $_POST['gradeSection'];
	$gradeId = $_POST['grade_id'];
	$batchYear = $_POST['newBatch'];

	if($_POST['studentIds']!="" && $_POST['studentIds']!="undefined") {
		$studentsArr = explode(",", $_POST['studentIds']);
		if(!empty($studentsArr)) {
			foreach($studentsArr as $kk=>$vv) { 
				Student::updateStudentByField("is_new_student", "Y", $vv);
				Student::updateStudentByField("batch_year", $batchYear, $vv);
			}
		}
	}
	exit();

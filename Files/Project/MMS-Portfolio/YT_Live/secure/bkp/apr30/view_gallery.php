...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="popuptbl">
   	<tr>
    	<th><strong>Galleries</strong>
        	<div style="float:right; margin-top:10px;" class="cursor"><img src="images/edit_icon.png" alt="Edit Gallery" title="Edit Gallery" align="absmiddle" style="cursor:pointer;" id="editglryimg" onclick="editGalleryDtls(<?=$eventId?>)" /></div>
        </th>
    </tr>
    <tr>
					...
					?>
                    	<td valign="top" style="padding:5px;">
                        	<div style="border:1px solid #666; padding:10px; width:200px;">
                            	<div align="center"><a href="<?=EVENT_GALLERY_HREF.$gv->photo_file?>" target="_blank"><img src="<?=EVENT_GALLERY_HREF.$gv->photo_file?>" width="200" height="150" /></a></div>

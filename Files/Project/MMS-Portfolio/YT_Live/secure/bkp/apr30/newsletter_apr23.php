		...
		ini_set('max_execution_time', 500000000000);
			...
			foreach($emailArr as $K_Mem=>$V_Mem){
					...
					if($sentCnt<=500) { 
						...
						Circulars::insertCircularMailLog($_POST['nid'], $email_log_type, $emailName, $studentName, $emailAddress, $contact_number, 'Y');
                ...
                ?>
                    ...
                    <tr bgcolor="<?=$bgcolor?>">
                      ...
                      <td align="center" <?=($V->mail_type!="S")?"colspan=2":""?>>
                      	<div class="combutton pull_right padlr10 padtb10 txtbold letterspac f12" onclick="resendEmail('<?=$V->id?>', '<?=$circularId?>')">Resend</div>
                      </td>
                    </tr>

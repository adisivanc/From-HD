...
if($_POST['act']=='blogPostSubmit'){
	...
	if($_POST['publish_date']=="" || $_POST['publish_date']=="0000-00-00") $publish_date=""; else $publish_date=$_POST['publish_date'];
	
	if($_POST['buttonValue']=="Publish" || $_POST['buttonValue']=="Save"){
		if($_POST['blog_db_id']!='' && $_POST['blog_db_id']!='undefined'){
			
			$rsBlogUpd = Blog::updateBlogPost($school_id,$categoryVal,$_POST['blog_title'],$_POST['featured_article'],$_POST['blog_content'],$_POST['blog_subtitle'],$publish_date,$_POST['labels'],$_POST['comment_options'],$_POST['compose_mode'],$_POST['video_url'],$status, $_POST['blog_db_id'], $_SESSION['YTUserId']);

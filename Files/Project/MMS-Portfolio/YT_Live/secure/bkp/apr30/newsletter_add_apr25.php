...
<div class="newsletter_cntr">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="newsheadertbl border_bottom">
      <tr>
        ...
        <td><input type="text" style="width:70%;" class="txtbox" id="welcome_note" name="welcome_note" value="<?=($rs_circular->welcome_note=="")?"Dear Parents,":stripslashes($rs_circular->welcome_note)?>" /></td>
      </tr>
      <tr>
    ...
    <div class="fullsize txtwhite txtcenter f18">
    	<? if($rs_circular->id!=NULL) $buttonName = "UPDATE"; else $buttonName = "ADD"; ?>
        ...
        <? } ?>
        <div class="bgbrown pull_right margintb10 cursor padlr20 padtb10" onclick="submitNSForm('N');"><strong><?=$buttonName?></strong></div>
    </div> 

								...
								if(is_array($v1)) {
                                	...
                                	<?
										if(is_array($v2)) {
											...
											?>
                                            	<div style="margin-left:10px;"><input type="checkbox" name="circular_group[]" id="" class="mail_child_<?=$k1?>_<?=trim($slname[1])?> mail_child_<?=$k1?>" value="<?=trim($v3)?>:<?=$rs_schl->id?>" checked/> <?=$rs_grade->grade_name?></div>
                                            <?
											}
										}
									?> 
...
if($_POST['act']=="getAllEmailLogs") {
    ...
    <table width="1200" border="0" style="background:#FFFFFF;" class="popuptbl" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <div style="max-height:650px; overflow:auto; position:relative;">

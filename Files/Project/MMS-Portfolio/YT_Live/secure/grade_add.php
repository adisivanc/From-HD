   ...
   <tr>
    <td align="right" colspan="2">
    	<div class="fullsize txtwhite txtcenter f18">
        	<div class="bgbrown pull_right marginleft20 margintb10 cursor padlr20 padtb10" id="gradeSaveBtn" onClick="saveGrade('<?=$gradeId?>')"><strong>Submit</strong></div>
            <div class="bgbrown pull_right marginleft20 margintb10 cursor padlr20 padtb10" id="gradeProcessBtn" style="display:none;"><strong>Processing..</strong></div>
        </div>
    </td>
  </tr>
</table>

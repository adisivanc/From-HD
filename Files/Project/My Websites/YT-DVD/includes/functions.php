...
function getSeoUrl($argvs=array()){
	...
	switch($pn)
	{
		...
		{
			$seourl='yt-free-human-being';	
			break;
		}
		case 'yt_fundamentals.php':
		{
			$seourl='yt-fundamentals';	
			break;
		}
		case 'teacher.php':
		{
			$seourl='meet-our-akkas';	
			break;
		}
		case 'yt_rhythm.php':
		{
				...
				switch($Type)
				{
					case 'reg':
					{
						if($EventId=='' || $EventId==0)
							$seourl='yt-event-registration';	
						else
						{
							$rs_event = Events::getEventsById($EventId);
							$event_name = strtolower($rs_event->event_name);
							$search = array('-', ',', ':', ' ', '  ');
							$replace = array('');
							$evnt_str = str_replace($search, $replace, $event_name);
							$seourl='yt-event-'.$evnt_str.'-registration';
							//	get event name and make seourl = yt-event-{event_name}-registration	
						}
						break;
					}
				}
			...
			if($Type && $RegStatus)
			{
				switch($Type)
				{
					case 'reg':
					{
						...
						{
							$seourl='yt-event-registration-thankyou';
							//	get event name and make seourl = yt-event-{event_name}-registration	
						}
						break;
					}
		...
		case 'newsletter/website_lanch.php':
		{
			$seourl='newsletter/yellow-train-website-launch';	
			break;
		}
		case 'newsletter/indian_rollers.php':
		{
			$seourl='newsletter/yt-indian-rollers';	
			break;
		}
		case 'newsletter/drongos.php':
		{
			$seourl='newsletter/yt-drongos';	
			break;
		}
		case 'blog-details.php':
		{
			...
			{
				$rs_blog = Blog::getBlogPostById($BlogId);
				$blog_name = strtolower($rs_blog->blog_title);
				$search = array('-', ',', ':', ' ', '  ');
				$replace = "-";
				$evnt_str = str_replace($search, $replace, $blog_name);
				$seourl='blog-'.$evnt_str.'';
			}
			break;
		}
		case 'philosophy.php':
		{
			$seourl='yt-philosophy';	
			break;
		}
		case 'garden_campus.php':
		{
			$seourl='yt-garden-campus';	
			break;
		}
		case 'garden_teachers.php':
		{
			$seourl='yt-garden-campus-teachers';	
			break;
		}
		case 'garden_program.php':
		{
			$seourl='yt-garden-campus-program';	
			break;
		}
		case 'garden_rhythm.php':
		{
			$seourl='yt-garden-campus-rhythm';	
			break;
		}
		case 'admission.php':
		{
...
function generatePagination($functionName="", $arrayCount, $arraySliceCount, $pageLimit=10, $adjacent=1, $page=1, $type="") {
    ...
    {   
        ...
        if ($page > 1)
            $pagination.= "<a style='cursor:pointer' class='pagination_box' border='0' id='pagination_prev1' onClick='".$functionName."Paging(".($prev).", &quot;".$type."&quot;);'></a>";
        else
            $pagination.= "<span class='disabled pagination_box' id='pagination_prev1' style='cursor:pointer' border='0'></span>";
        ...
        if($page < $counter - 1)
            $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box' id='pagination_next1' onClick='".$functionName."Paging(".($next).", &quot;".$type."&quot;);'></a>";
        else
            $pagination.= "<span class='disabled pagination_box' id='pagination_next1' style='cursor:pointer' border='0'></span>";
...
function generateMenuPagination($functionName="", $arrayCount, $arraySliceCount, $pageLimit=10, $adjacent=1, $page=1, $type="") {
    ...
    {   
        ...
        if ($page > 1)
            $pagination.= "<a style='cursor:pointer' class='pagination_box1' border='0' id='pagination_prev' onClick='".$functionName."Paging(".($prev).", &quot;".$type."&quot;);'><span style='font-size:16px;'><</span></a>";
        else
            $pagination.= "<span class='disabled pagination_box1' id='pagination_prev' style='cursor:pointer' border='0'><span style='font-size:16px;'><</span></span>";
        ...
        {   
            ...
            {  
                if ($counter == $page)
                    $pagination.= "<span class='pagination_active1 pagination_box1' style='cursor:pointer' border='0'>".sprintf("%02s", $counter)."</span>";
                else
                    $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' onClick='".$functionName."Paging(".($counter).", &quot;".$type."&quot;);'>".sprintf("%02s", $counter)."</a>";     
            }
        }
        elseif($lastpage > 4 + ($adjacents * 2))
        {
            if($page < 1 + ($adjacents * 2))
            {
                ...
                $pagination.= "<span class='pagination_box1' style='background:none; border:none; color:#000;'>...</span>";
                $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' onClick='".$functionName."Paging(".($lpm1).", &quot;".$type."&quot;);'>".sprintf("%02s", $lpm1)."</a>";
                $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' onClick='".$functionName."Paging(".($lastpage).", &quot;".$type."&quot;);'>".sprintf("%02s", $lastpage)."</a>";   
           
           }
           elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
           {
               $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' onClick='".$functionName."Paging(1, &quot;".$type."&quot;);'>1</a>";
               $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' onClick='".$functionName."Paging(2, &quot;".$type."&quot;);'>2</a>";
               $pagination.= "<span class='pagination_box1' style='background:none; border:none; color:#000;'>...</span>";
               for($counter = ($page - $adjacents)+1; $counter <= ($page + $adjacents)+1; $counter++)
               {
                   if($counter == $page)
                       $pagination.= "<span class='pagination_active1 pagination_box1' style='cursor:pointer' border='0' onClick='".$functionName."Paging(".($counter).", &quot;".$type."&quot;);'>".sprintf("%02s", $counter)."</span>";
                   else
                       $pagination.= "<a style='cursor:pointer' class='pagination_box1' border='0' onClick='".$functionName."Paging(".($counter).", &quot;".$type."&quot;);'>".sprintf("%02s", $counter)."</a>";     
               }
               $pagination.= "<span class='pagination_box1' style='background:none; border:none; color:#000;'>..</span>";
               $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' onClick='".$functionName."Paging(".($lpm1).", &quot;".$type."&quot;);'>".sprintf("%02s", $lpm1)."</a>";
               $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' onClick='".$functionName."Paging(".($lastpage).", &quot;".$type."&quot;);'>".sprintf("%02s", $lastpage)."</a>";   
           ...
           {
               $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' onClick='".$functionName."Paging(1, &quot;".$type."&quot;);'>".sprintf("%02s", 1)."</a>";
               $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' onClick='".$functionName."Paging(2, &quot;".$type."&quot;);'>".sprintf("%02s", 2)."</a>";
               $pagination.= "<span class='pagination_box1' style='background:none; border:none; color:#000;'>..</span>";
               for($counter = $lastpage - (2 + ($adjacents * 2)); $counter <= $lastpage; $counter++)
               {
                   if($counter == $page)
        ...
        if($page < $counter - 1)
            $pagination.= "<a style='cursor:pointer' border='0' class='pagination_box1' id='pagination_next' onClick='".$functionName."Paging(".($next).", &quot;".$type."&quot;);'><span style='font-size:16px;'>></span></a>";
        else
            $pagination.= "<span class='disabled pagination_box1' id='pagination_next' style='cursor:pointer' border='0'><span style='font-size:16px;'>></span></span>";
        
    }
	$table_val = "<div style='line-height:25px; font-size:14px;'><b>Showing ".($start+1)." to ".($start+$resultSplitCount)." of ".$resultCount." entries</b></div>";
	$table_val .= "<div style='clear:both; margin-top:10px; float:right;'>".$pagination."</div>";
	
	return $table_val;
		 
}

function generateFrontPagination($functionName="", $arrayCount, $arraySliceCount, $pageLimit=10, $adjacent=1, $page=1, $type="") {
    ...
    {   
        ...
        /*if ($page > 1)
            $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(".($prev).", &quot;".$type."&quot;);'></a></li>";
        else
            $pagination.= "<li></li>";*/
        ...
        {   
            ...
            {  
                if ($counter == $page)
                    $pagination.= "<li>".sprintf("%02s", $counter)."</li>";
                else
                    $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(".($counter).", &quot;".$type."&quot;);'>".sprintf("%02s", $counter)."</a></li>";     
        ...
        elseif($lastpage > 4 + ($adjacents * 2))
        {
            if($page < 1 + ($adjacents * 2))
            {
                ...
                $pagination.= "...";
                $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(".($lpm1).", &quot;".$type."&quot;);'>".sprintf("%02s", $lpm1)."</a></li>";
                $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(".($lastpage).", &quot;".$type."&quot;);'>".sprintf("%02s", $lastpage)."</a></li>";   
           
           }
           elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
           {
               $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(1, &quot;".$type."&quot;);'>1</a></li>";
               $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(2, &quot;".$type."&quot;);'>2</a></li>";
               $pagination.= "<li>...</li>";
               for($counter = ($page - $adjacents)+1; $counter <= ($page + $adjacents)+1; $counter++)
               {
                   if($counter == $page)
                       $pagination.= "<li><div>".$functionName."Paging(".($counter).", &quot;".$type."&quot;);'>".sprintf("%02s", $counter)."</div></li>";
                   else
                       $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(".($counter).", &quot;".$type."&quot;);'>".sprintf("%02s", $counter)."</a></li>";     
               }
               $pagination.= "<li>..</li>";
           ...
           {
               $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(1, &quot;".$type."&quot;);'>".sprintf("%02s", 1)."</a></li>";
               $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(2, &quot;".$type."&quot;);'>".sprintf("%02s", 2)."</a></li>";
               $pagination.= "<li>..";
               for($counter = $lastpage - (2 + ($adjacents * 2)); $counter <= $lastpage; $counter++)
               {
                   if($counter == $page)
       ...
       /* if($page < $counter - 1)
            $pagination.= "<li><a style='cursor:pointer' border='0' onClick='".$functionName."Paging(".($next).", &quot;".$type."&quot;);'></a></li>";
        else
            $pagination.= "<li></li>";*/

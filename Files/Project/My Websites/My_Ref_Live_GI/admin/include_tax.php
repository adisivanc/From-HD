...
<tr>
<td colspan="2" style="padding:10px; background-color:#FFF">No Tax Added Yet!</td>
</tr>
</table>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#cccccc; margin-top:15px; margin-bottom:15px;"> 
    <tr>
        <td align="center" style="padding:10px 0;">
            <a onClick="add_new_tax()" style="cursor:pointer; font-size:14px; background:#FFFFCC; padding:10px 20px;"><strong>Add New Tax</strong></a>
        </td>
    </tr>
</table>
...
<tr>
    <td style="padding:10px"><a onclick="" style="cursor:pointer">TTTTTT</a> </td>
    <td width="75"> 
...
<tr>
<td colspan="2" style="padding:10px; background-color:#FFF">No Suppliers Added Yet!</td>
</tr>
</table>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#cccccc; margin-top:15px;"> 
    <tr>
        <td align="center" style="padding:10px 0;">
            <a onClick="add_new_suppiler()" style="cursor:pointer; font-size:14px; background:#FFFFCC; padding:10px 20px;"><strong>Add New Supplier</strong></a>
        </td>
    </tr>
</table>
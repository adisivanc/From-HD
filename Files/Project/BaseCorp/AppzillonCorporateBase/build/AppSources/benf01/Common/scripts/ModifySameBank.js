apz.benf01.ModifySameBank = {};
apz.app.onLoad_ModifySameBank = function(params) {
    apz.benf01.ModifySameBank.sCorporateId = apz.Login.sCorporateId;
    var req = {};
    req.beneficiaryDetails = {
        "corporateId": apz.benf01.ModifySameBank.sCorporateId,
        "beneficaryType": "Same",
    ...
    var lServerParams = {
        ...
        "paintResp": "Y",
        "async": "true",
        "callBack": apz.benf01.ModifySameBank.fetchBeneficaryDetailsQueryCB,
        "callBackObj": "",
    };
    lServerParams.req = req;
    apz.server.callServer(lServerParams);
};
apz.benf01.ModifySameBank.fetchBeneficaryDetailsQueryCB = function(params) {
    debugger;
...
apz.benf01.ModifySameBank.saveDetails = function() {
    debugger;
    if (apz.val.validateContainer('benf01__ModifySameBank__addBeneficaryForm') == false) {
        var msg = {
            "code": 'benf01_mand'
        };
        apz.dispMsg(msg);
        ...
        taskObj.taskType = "MODIFY_BENEFICARY_SAME";
        taskObj.versionNo = "1";
        ...
        lUserObj.callBack = apz.benf01.ModifySameBank.workflowMicroServiceCB;
        lUserObj.operation = "NEWWORKFLOW";
        var lParams = {
            "appId": "acwf01",
            "scr": "WorkFlow",
            "div": "benf01__ModifySameBank__LaunchMicroService",
            "layout": "All",
            "type": "CF",
            "userObj": lUserObj
        };
...
apz.benf01.ModifySameBank.workflowMicroServiceCB = function(pRespObj) {
    debugger;
    ...
    if (pRespObj.tbDbmiWorkflowMaster.status != "COMPLETED") {
        if (pRespObj.tbDbmiWorkflowMaster.stageType == "USERTASK") {
            if (pRespObj.stageAccess) {
                ...
                var msg = {
                    "code": 'benfo1_approve',
                    //"callBack": apz.benf01.ModifySameBank.Confirmation
                };
                apz.dispMsg(msg);
                var lParams = {
                    "appId": "tscm01",
...
apz.benf01.ModifySameBank.fnCancel = function() {

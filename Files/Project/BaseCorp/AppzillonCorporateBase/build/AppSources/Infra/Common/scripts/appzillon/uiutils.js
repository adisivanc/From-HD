Apz.prototype.accordionAction = function(obj) {
    ...
    if(!(cntrData.type == "FORM" && cntrData.readOnly == "Y")){
      ...
      var editableType="",editFieldClasses="",source="";
    ...
    var todaysMonth = present.getMonth();
      ...
      //Bug fix : changed the objMinDate assignment to adopt to latest mobiscroll plugin
			objMinDate = new Date(present.getFullYear(), todaysMonth, todaysDate);
      ...
      //Bug fix : changed the objMaxDate assignment to adopt to latest mobiscroll plugin
			//objMaxDate = present;
      		objMaxDate = new Date(present.getFullYear(), todaysMonth, todaysDate);

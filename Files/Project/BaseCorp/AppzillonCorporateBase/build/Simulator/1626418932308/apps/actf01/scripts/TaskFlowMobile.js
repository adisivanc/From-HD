...
apz.actf01.TaskFlowMobile.fetchDetailsQueryCB = function(pResp) {
    ...
    if (!apz.mockServer) {
        ...
        if (lParams.scr == "WithinBankVerify" || lParams.scr == "AddLCApprove" || lParams.scr == "AddLCVerify" || lParams.scr == "GuaranteeApprove" || lParams.scr == "GuaranteeVerify") {
